                        ...
                        <div class="header_side clearfix <?php echo esc_attr($header_side_class); ?>">
                            <div class="container">
                                <div class="header_side_wrapper">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($copyright = get_theme_mod('header_copyright', __("Theme by <a href='https://kodcular.net/' target='_blank'>Ali Kaygusuz</a> <br>2016 &copy; All rights reserved.", 'Vodafone'))): ?>
